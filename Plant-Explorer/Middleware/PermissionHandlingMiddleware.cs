...
namespace Plant_Explorer.Middleware
{
    ...
    public class PermissionHandlingMiddleware
    {
        ...
        public PermissionHandlingMiddleware(RequestDelegate next, ILogger<PermissionHandlingMiddleware> logger)
        {
            ...
            _excludedUris = new()
            {
                    { "GET", new List<string>() { "/api/applicationcategory", "/api/characteristiccategory", "/api/Plant", "/api/users" } },
                    { "POST", new List<string>() { "/api/applicationcategory", "/api/characteristiccategory", "/api/Plant" } },
                    { "PUT", new List<string>() { "/api/applicationcategory", "/api/characteristiccategory", "/api/Plant" } },
                    { "DELETE", new List<string>() { "/api/applicationcategory", "/api/characteristiccategory", "/api/Plant" } },
